...
var S = {
    init: function() {
        ...
        if (i !== -1) {
            ...
            S.UI.simulate('Welcome|to Play|This Game| |Ready|#countdown 3|Go||');
        }
        ...
        timedAction(function(index) {
            ...
            switch (action) {
                ...
                case 'rectangle':
                    ...
                    S.Shape.switchShape(S.ShapeBuilder.rectangle(Math.min(maxShapeSize, parseInt(value[0])), Math.min(
                        maxShapeSize, parseInt(value[1]))));
                    break;
...
S.ShapeBuilder = (function() {
    var gap = 13,
        ...
        fontSize = 420,
        fontFamily = 'Avenir, Helvetica Neue, Helvetica, Consolas, sans-serif';
    ...
    return {
        ...
        switchShape: function(n, fast) {
            ...
            while (n.dots.length > 0) {
                ...
                dots[d].e = fast ? 0.26 : (dots[d].s ? 0.29 : 0.28); //速率的二项分布
